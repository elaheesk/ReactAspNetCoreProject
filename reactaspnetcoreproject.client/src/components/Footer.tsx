        ...
        <section className="bg-black">
            <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
                <nav className="flex flex-wrap justify-center -mx-5 -my-2">
                    ...
                    <div className="px-5 py-2">
                        <Link className="text-base leading-6 text-white hover:text-gray-900" to="/quotes">Quotes</Link>
                    </div>
                    <div className="px-5 py-2">
                        <a href="mailto:elahe199108@gmail.com" target="_blank" className="text-base leading-6 text-white hover:text-gray-900">
                            Contact
                        </a>
                    </div>
                </nav>
